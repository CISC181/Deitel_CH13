...
public class CoverViewerController {
   ...
   public void initialize() {
      ...
      books.add(new Book("Android How to Program", 
         "/CoverViewer/images/small/androidhtp.jpg", "/CoverViewer/images/large/androidhtp.jpg"));
      books.add(new Book("C How to Program", 
         "/CoverViewer/images/small/chtp.jpg", "/CoverViewer/images/large/chtp.jpg"));
      books.add(new Book("C++ How to Program",
         "/CoverViewer/images/small/cpphtp.jpg", "/CoverViewer/images/large/cpphtp.jpg"));
      books.add(new Book("Internet and World Wide Web How to Program",  
         "/CoverViewer/images/small/iw3htp.jpg", "/CoverViewer/images/large/iw3htp.jpg"));
      books.add(new Book("Java How to Program", 
         "/CoverViewer/images/small/jhtp.jpg", "/CoverViewer/images/large/jhtp.jpg"));
      books.add(new Book("Visual Basic How to Program", 
         "/CoverViewer/images/small/vbhtp.jpg", "/CoverViewer/images/large/vbhtp.jpg"));
      books.add(new Book("Visual C# How to Program", 
         "/CoverViewer/images/small/vcshtp.jpg", "/CoverViewer/images/large/vcshtp.jpg"));
            ...
            new ChangeListener<Book>() {                                   
               ...
               public void changed(ObservableValue<? extends Book> ov,
                  ...
                  coverImageView.setImage(
                     new Image(getClass().getResourceAsStream(newValue.getLargeImage())));
               }
            }
         );                                                                  
   }     
